...
export const promoTranslations: Record<PromoLanguage, PromoTranslation> = {
  en: {
    ...
    counterCard: "Small QR Counter Card",
    counterCardDescription: "Small printable card for DJ booths, bars, and counters.",
  ...
  zh: {
    ...
    counterCard: "小型二维码台卡",
    counterCardDescription: "适合 DJ 台、酒吧和柜台的小型可打印卡片。",
  ...
  ja: {
    ...
    counterCard: "小型QRカウンターカード",
    counterCardDescription: "DJブース、バー、カウンター向けの小型印刷カード。",
  ...
  ko: {
    ...
    counterCard: "소형 QR 카운터 카드",
    counterCardDescription: "DJ 부스, 바, 카운터용 작은 인쇄 카드입니다.",
  ...
  id: {
    ...
    counterCard: "Kartu QR Counter Kecil",
    counterCardDescription: "Kartu kecil untuk booth DJ, bar, dan meja counter.",
  ...
  ms: {
    ...
    counterCard: "Kad QR Kaunter Kecil",
    counterCardDescription: "Kad kecil boleh cetak untuk booth DJ, bar dan kaunter.",
    highResolutionQrPng: "QR PNG Resolusi Tinggi",
  ...
  th: {
    ...
    counterCard: "การ์ด QR เคาน์เตอร์ขนาดเล็ก",
    counterCardDescription: "การ์ดพิมพ์ขนาดเล็กสำหรับบูธ DJ บาร์ และเคาน์เตอร์",
  ...
  hi: {
    ...
    counterCard: "छोटा QR काउंटर कार्ड",
    counterCardDescription: "DJ बूथ, बार और काउंटर के लिए छोटा प्रिंट कार्ड।",
  ...
  ar: {
    ...
    counterCard: "بطاقة QR صغيرة للكاونتر",
    counterCardDescription: "بطاقة صغيرة للطباعة لمنصة DJ والبار والكاونتر.",
  ...
  vi: {
    ...
    counterCard: "Thẻ QR quầy nhỏ",
    counterCardDescription: "Thẻ nhỏ có thể in cho booth DJ, quầy bar và quầy phục vụ.",
  ...
  tl: {
    ...
    counterCard: "Maliit na QR Counter Card",
    counterCardDescription: "Maliit na printable card para sa DJ booth, bar, at counter.",
    highResolutionQrPng: "High Resolution QR PNG",
  ...
  pt: {
    ...
    counterCard: "Cartao QR pequeno de balcão",
    counterCardDescription: "Cartao pequeno para cabines de DJ, bares e balcoes.",
  ...
  es: {
    ...
    counterCard: "Tarjeta QR pequena de mostrador",
    counterCardDescription: "Tarjeta pequena para cabinas de DJ, bares y mostradores.",
  ...
  fr: {
    ...
    counterCard: "Petite carte QR de comptoir",
    counterCardDescription: "Petite carte imprimable pour cabines DJ, bars et comptoirs.",
  ...
  de: {
    ...
    counterCard: "Kleine QR-Thekenkarte",
    counterCardDescription: "Kleine Druckkarte fuer DJ-Booths, Bars und Theken.",
  ...
  ru: {
    ...
    counterCard: "Малая QR-карта для стойки",
    counterCardDescription: "Небольшая печатная карта для DJ-зоны, бара и стойки.",
  ...
  tr: {
    ...
    counterCard: "Kucuk QR Tezgah Karti",
    counterCardDescription: "DJ kabini, bar ve tezgahlar icin kucuk yazdirilabilir kart.",
  ...
  it: {
    ...
    counterCard: "Piccola card QR da banco",
    counterCardDescription: "Piccola card stampabile per postazioni DJ, bar e banconi.",
  ...
  nl: {
    ...
    counterCard: "Kleine QR-baliekaart",
    counterCardDescription: "Kleine printbare kaart voor DJ-booths, bars en balies.",
  ...
  pl: {
    ...
    counterCard: "Mała karta QR na ladę",
    counterCardDescription: "Mała karta do druku dla stanowisk DJ, barów i lad.",
  ...
  el: {
    ...
    counterCard: "Μικρή κάρτα QR πάγκου",
    counterCardDescription: "Μικρή εκτυπώσιμη κάρτα για DJ booth, μπαρ και πάγκους.",
  ...
  uk: {
    ...
    counterCard: "Мала QR-картка для стійки",
    counterCardDescription: "Невелика друкована картка для DJ-зони, бару та стійки.",
